...
We can see that `r round(cumulative_adopt_count(ah_simresults_threshold1)["prop", 2], 3)` adopted by period 2, `r round(cumulative_adopt_count(ah_simresults_threshold1)["prop", 3], 3)` by period 3, etc. It is also useful to plot the cumulative distribution of adopters. Here we can use the `plot_adopters()` function, with the diffnet object as input. 
