...
This book was built using R version `r getRversion()` on `r paste(format(Sys.Date(),format = "%B"), " ",  format(Sys.Date(),format = "%d"),", ", format(Sys.Date(),format = "%Y"), sep = "")`. See below for the session information:

```{r, echo = F}
sessioninfo::session_info(c("sna", "network", "igraph", "RSiena","ergm", "tergm",
  "ndtv", "intergraph", "GGally", "ggplot2", "ggnetwork", "networkD3", "networkDynamic", "egor", "car", "NbClust"))
```
